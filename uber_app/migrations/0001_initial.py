# Generated by Django 4.2.8 on 2023-12-10 15:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Work_Status', models.BooleanField(default=True)),
                ('Off', models.ForeignKey(db_column='Off', on_delete=django.db.models.deletion.PROTECT, related_name='OffPassengers', to='uber_app.routestation')),
                ('On', models.ForeignKey(db_column='On', on_delete=django.db.models.deletion.PROTECT, related_name='OnPassengers', to='uber_app.routestation')),
        ...
        migrations.AddField(
            model_name='request',
            name='Off',
            field=models.ForeignKey(db_column='Off', on_delete=django.db.models.deletion.PROTECT, related_name='+', to='uber_app.routestation'),
        ),
        migrations.AddField(
            model_name='request',
            name='On',
            field=models.ForeignKey(db_column='On', on_delete=django.db.models.deletion.PROTECT, related_name='+', to='uber_app.routestation'),
        ),
        migrations.AddField(
            model_name='request',
            name='Passenger',
